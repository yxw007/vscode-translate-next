...
- Supports reusing login credentials across multiple VSCode windows 
...
- **style:** Markdown preview translation button is too dark 
...
- Compress the size of presentation pictures to avoid slow loading of presentation pictures 
...
- Update README files to include selected text translation feature and troubleshooting tips 
