...
import { checkScopeFunction, ICommentBlock, ICommentToken, ITokenState } from "../common";
...
export class CommentParse {
    ...
    /**
     * Get the CommentToken within the scope of the comment
     *
     * @param range Scope of annotation
     * @param opts
     * @returns
     */
    ...
    public computeText(position: Position): ICommentBlock | null {
        ...
        //If the string contains \n, etc., you need to merge consecutive tokens on the current line.
